 ...
 * stores all info retrieved from the xml file
 * loads xml, scans
 */
class MySceneGraph {
    /**
    ...
    constructor(filename, scene) {
		 ...
		 * this serve para voltar a chamar quando todo ficheiro lido => onXmlReady
		 * aplicacao arranca antes de todo lido app.run
         */
    ...
    parseXMLFile(rootElement) {
        ...
        if ((index = nodeNames.indexOf("transformations")) == -1)
            return "tag <Ttransformations> missing";
        else {
